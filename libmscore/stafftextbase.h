...
class StaffTextBase : public TextBase  {
   ...
   public:
      ...
      void setSwingParameters(int unit, int ratio, int offset) { _swingParameters.swingUnit = unit; _swingParameters.swingRatio = ratio; _swingParameters.laidbackOffset = offset;}
